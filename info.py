...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Join[Our Offical Channel]for Support(https://t.me/RelaxroomBkp)\n ɴᴀᴍᴇ: <code>{file_name}</code></b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "Join[Our Offical Channel]for Support(https://t.me/RelaxroomBkp)\n ɴᴀᴍᴇ: <code>{file_name}</code></b>")
